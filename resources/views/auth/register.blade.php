                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="relative w-full mt-10 space-y-8">
                                <div class="relative">
                                    ...
                                    <input
                                        class="block w-full px-4 py-3 mt-2 placeholder-gray-400 bg-gray-200 focus:outline-none focus:ring-4 focus:ring-green-400 focus:ring-opacity-50 rounded-xl"
                                ...
                                <div class="relative">
                                    <button type="submit"
                                        class="inline-block w-full px-5 py-3 text-lg font-medium text-center text-white transition duration-200 bg-green-400 hover:bg-green-500 ease rounded-xl">
                                        {{ __('Register') }}
                                    </button>
                                </div>
                            </div>
