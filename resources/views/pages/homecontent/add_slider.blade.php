<div id="add-slider-modal" aria-hidden="true"
        ...
        <div class="bg-white rounded-lg shadow relative">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="add-slider-modal">
            ...
            <form action="{{ route('homecontent.store') }}" method="post" enctype="multipart/form-data">
                <div class="p-6 space-y-6 w-full">
                    ...
                    <div class="mb-6 space-y-2">
                        <label class="text-gray-500 font-bold" for="name">Title</label>
                        <textarea name="title"
                    ...
                    <div class="mb-6 space-y-2">
                        <label class="text-gray-500 font-bold" for="payment_notes">Subtitle</label>
                        <textarea name="subtitle"
                            class="font-semibold border border-gray-300  sm:text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                            rows="4" cols="10"></textarea>
                    </div>
                    <div class="mb-6 space-y-2">
                        <label class="text-gray-500 font-bold" for="image">Gambar</label>
                        <input class="block w-full cursor-pointer bg-gray-50 border border-gray-300 text-gray-900 focus:outline-none focus:border-transparent text-sm rounded-lg
