...
@section('content')
    <section class="pt-10 pb-20 bg-white md:px-0 w-full">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-0 w-full">
            ...
            <div class="md:flex">
                <div class="flex-initial md:mr-5  bg-white shadow-md border border-gray-200 rounded-lg max-w-sm">
                    <div class="p-8 bg-green-400 h-32 relative flex justify-center">
                ...
                <div class="flex-1 bg-white mt-5 md:mt-0 p-6 shadow-md border border-gray-200 rounded-lg">
