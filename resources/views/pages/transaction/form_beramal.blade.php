...
@section('content')
    <section class="overflow-hidden md:mt-0 mt-5 w-full md:py-24 md:bg-green-50 justify-items-center items-center">
        <div class="container md:max-w-6xl mx-auto flex md:flex-row flex-col">

            <div class="w-full space-y-5 md:w-3/5 md:pr-16 md:px-0 px-8 md:mt-0 mt-16">
